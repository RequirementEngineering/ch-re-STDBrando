...
| Alternative scenario:  | 1. The system detects that the user name or password are not correct or do not exist in it and shows a error |
| | message, telling the actor the information introudced are not correct. |
